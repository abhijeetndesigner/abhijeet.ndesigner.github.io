...
const SOCIAL_LINKS = [
  { href: "https://linkedin.com/in/abhijeetndesigner", label: "LinkedIn" },
  { href: "https://github.com/abhijeetndesigner", label: "GitHub" },
  { href: "https://read.cv/abhijeetndesigner", label: "Read.cv" },
];
    ...
    >
      ...
      <div className="mx-auto flex max-w-5xl flex-col gap-10 px-6 py-12 md:flex-row md:items-start md:justify-between">
        ...
        <div className="flex flex-col gap-3">
          ...
          <a
            href="mailto:hello@abhijeet.design"
            className="text-xs text-neutral-400 transition-colors duration-200 hover:text-white"
            aria-label="Send Abhijeet an email"
          >
            hello@abhijeet.design
          </a>
        </div>
      ...
      <div className="border-t border-zinc-900 py-4">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-6">
          <p className="text-[10px] tracking-wide text-neutral-500">
            © {year} Abhijeet. All rights reserved.
          </p>
          <p className="text-[10px] tracking-wide text-neutral-500">
